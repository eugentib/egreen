...
async function broadcast_nrb (mac, nrb) {
  let to_send = {}
  to_send.mac = mac
  to_send.nrb = nrb
...
function broadcastf (result) {
  broadcastAsync(result).then().catch()
}

async function clear_error (mac, msg = 'OK') {
